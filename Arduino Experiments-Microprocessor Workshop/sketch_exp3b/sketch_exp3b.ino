...
const int ledPin = 13; // digital pin 5 
...
void loop() { // Void loop is ran again and again and contains main code.
  ...
  if (ldrStatus >= 1020) {digitalWrite(ledPin, HIGH); // If LDR senses darkness led pin high that means led will glow. Adjust the threshold according to the LDR readings
