...
#define WIFI_SSID "sadhu"
#define WIFI_PASSWORD "s11p23q58r"

//For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyBFyII58gVvb8GyO2o5ARDiY5U18dQyi8M"

/* 3. Define the RTDB URL */
#define DATABASE_URL "nodemcu-cf6d4-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "coredumped05@gmail.com"
#define USER_PASSWORD "smolgirl@123"
